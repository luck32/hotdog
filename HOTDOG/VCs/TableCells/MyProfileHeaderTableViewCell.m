//
//  MyProfileHeaderTableViewCell.m
//  HOTDOG
//
...
@implementation MyProfileHeaderTableViewCell
...
- (void)setProfile:(HotdogMediaMeta *)profileMeta {
    ...
    int mediasCntInt = (int) [g_Base.myMediaMetaArray count];
    self.mediasCnt.text = [NSString stringWithFormat:@"%d", mediasCntInt];
    
    NSString *followersAPISuffix = [NSString stringWithFormat:@"people/%@/follows/count", g_Setting.userId];
    ...
    NSString *followedAPISuffix = [NSString stringWithFormat:@"people/%@/followedBy/count", g_Setting.userId];
